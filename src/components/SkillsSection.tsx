...
import {
  Code, Type, Palette, Wind, Atom, ArrowRight,
  FileJson, FileText, Github, Database, Feather,
  Terminal, CodeSquare, Laptop,
} from "lucide-react";

/* ─── icon registry ──────────────────────────────────────────────────────── */
const iconMap = {
  "C++": Code, Python: Code, "C#": Code,
  TypeScript: Type, JavaScript: Terminal,
  HTML5: CodeSquare, CSS3: Palette, "Tailwind CSS": Wind,
  React: Atom, "Next.js": ArrowRight, JSON: FileJson,
  Markdown: FileText, GitHub: Github, Supabase: Database,
  "Shadcn/ui": Feather,
};
    ...
    const obs = new IntersectionObserver(([e]) => {
      if (e.isIntersecting && !done.current) {
        ...
        const tick = (now) => {
          ...
          if (p < 1) requestAnimationFrame(tick); else setCur(target);
        };
...
const SkillCard = ({ skill, large = false }) => {
  ...
  return (
    ...
    >
      ...
      {/* hover top-left glow */}
      <div className={`absolute -top-8 -left-8 w-28 h-28 rounded-full bg-blue-600/15
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        {/* right mid */}
        <div className="absolute top-1/3 -right-24 w-[320px] h-[320px] rounded-full
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 mb-12">
        ...
        {/* unequal 3-col — slightly different widths feel intentional */}
        <div className="grid gap-4"
             style={{ gridTemplateColumns: "1fr 1.08fr 0.95fr" }}>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12">
        <div className="relative rounded-2xl border border-gray-400/50 overflow-hidden
                        bg-[#0a1020]">
          {/* top accent line */}
          <div className="absolute top-0 left-[10%] right-[10%] h-0.5
