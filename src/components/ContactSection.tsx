...
const ContactSection = () => {
  ...
  return (
    <section
      id="contact"
      className="pt-20 relative bg-gradient-to-b from-slate-900/40 via-black to-slate-900/50"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* Contact Info */}
          <div className="fade-in-up pt-16 text-center lg:text-left">
            {/* Added text-center for mobile consistency */}
